...
def loop():  # pragma: no cover
    ...
    front_cam_id = "/dev/v4l/by-id/usb-046d_0825_0560A5D0-video-index0"
...
def find_target(img, lower=np.array([335//2, 50*255//100, 55*255//100]), upper=np.array([355//2, 65*255//100, 70*255//100]), area_threshold=0.75 ** 2):
